...
async def get_analyzed_posts(
    ...
    post_source: str = Query("all", description="플랫폼 (x, truth_social_posts, truth_social_trends, all)"),
    ...
    try:
        ...
        return service.get_analysis_posts(db=db, skip=skip, limit=limit, post_source=post_source)
